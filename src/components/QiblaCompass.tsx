...
const QiblaCompass = () => {
  ...
  useEffect(() => {
    ...
    if (typeof DeviceOrientationEvent !== "undefined") {
      ...
      if (
        ...
        // We'll add a button to request permission
  ...
  if (isLoading) {
    return (
      <div className="islamic-card flex items-center justify-center min-h-[300px]">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative w-64 h-64 mb-4">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="absolute top-4 text-sm font-bold text-primary">
              N
            </span>
            <span className="absolute bottom-4 text-sm font-medium text-muted-foreground">
              S
            </span>
            <span className="absolute left-4 text-sm font-medium text-muted-foreground">
              W
            </span>
          ...
          <div className="text-center space-y-2">
            ...
            {!compassSupported && (
              <p className="text-xs text-muted-foreground">
                Point your device towards {getDirectionLabel(qiblaDirection)} to
                face Qibla
              </p>
            )}
          </div>
